const { PERSON_ID, PERSON_TOKEN, DOMAIN } = require("./config");
 ...
 * @returns
 */
const generateSaleTicket = (voucher) => {
  return {
    personaId: PERSON_ID,
 ...
 */
const uploadSaleTicket = async (saleTicket) => {
 ...
 */
const verifyResponseSaleTicket = async (documentId) => {
